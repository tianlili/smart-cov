...
/**
Initializes the __coverage__ object in a window.  This should be the first
                ...
                if (request.readyState === 4) {
                    try {
                        ...
                        for (file in json) {
                            ...
                            __coverage__[file] = fileCoverage.coverage;
                            __coverage__[file].code = fileCoverage.code;
                        }
                        jscoverage_recalculateSummaryTab();
                        summaryThrobber.style.visibility = 'hidden';
                    } catch (e) {
...
function jscoverage_recalculateSummaryTab() {
...
function jscoverage_recalculateSourceTab() {
    ...
    var coverage = __coverage__[jscoverage_currentFile], lines = coverage.code;
...
function jscoverage_serializeCoverageToJSON() {
    ...
    for (var file in __coverage__) {
        if (!__coverage__.hasOwnProperty(file)) {
            continue;
        }
